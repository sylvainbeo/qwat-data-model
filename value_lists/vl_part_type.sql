...
INSERT INTO qwat_vl.part_type (id, value_en, value_fr, value_ro, vl_active) VALUES (9200, 'subscriber meter', 'compteur abonné', 'apometru abonat', true);
INSERT INTO qwat_vl.part_type (id, value_en, value_fr, value_ro, vl_active) VALUES (9201, 'stopper', 'bouchon', 'dop', true);
INSERT INTO qwat_vl.part_type (id, value_en, value_fr, value_ro, vl_active) VALUES (9202, 'watering hose', 'bouche d''arrosage', 'gură de stropire/pulverizare', true);
...
INSERT INTO qwat_vl.part_type (id, value_en, value_fr, value_ro, vl_active) VALUES (9205, 'end fitting', 'raccord de fin (bouchon)', 'capăt reţea', false);
INSERT INTO qwat_vl.part_type (id, value_en, value_fr, value_ro, vl_active) VALUES (9206, 'reduction fitting', 'réducteur de diamètre', 'fiting reductor', true);
INSERT INTO qwat_vl.part_type (id, value_en, value_fr, value_ro, vl_active) VALUES (9207, 'cross fitting', 'raccord en croix', 'fiting tip cruce', true);
